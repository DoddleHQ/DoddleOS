---
name: schema-markup
id: doddle.marketing.schema-markup
version: 1.5.1
...
|-------|------|----------|-------------|
| topic_or_url | string | yes | Page URL or topic needing schema; ask if missing |
| keyword | string | no | Target query or schema type hint; infer if missing |
...
|--------|------|-------------|
| report | markdown | Schema audit with JSON-LD implementation, see Output Format |
| action_list | json | Prioritized schema fixes with impact |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.gsc.getSearchAnalytics | Rich result performance | Queries, CTR, enhancements | no |
| doddle.tool.v1.dataforseo.serpGoogle | SERP features | Rich snippet presence | no |
| doddle.tool.v1.ga4.getReport | Traffic impact | Sessions, conversions | no |
...
|-------|--------------------|--------------------|
| seo-specialist | Schema strategy, validation | Type selection, error review |
| copywriter | Content alignment | Schema-matching copy |
| docs-manager | Implementation docs | Placement guides |
