---
name: ab-test-setup
id: doddle.marketing.ab-test-setup
version: 1.5.1
...
- Planning a new A/B or A/B/n test
- Writing a testable hypothesis
- Sizing sample and duration
- Designing control vs variant
...
|-------|------|----------|-------------|
| hypothesis | string | yes | Hypothesis statement for the test |
| page_url | string | no | Page URL under test |
...
|--------|------|-------------|
| test_plan | markdown | Test design, see Expected Output |
| variants | json | Control and variant definitions |
...
|--------|------------|--------|------|
| Sample size reached | Achieved / target per variant | 100% | doddle.tool.v1.ga4.getReport |
| Primary metric lift | Variant vs control change | > MDE | doddle.tool.v1.ga4.getReport |
| Statistical confidence | 1 - p-value | ≥95% | doddle.tool.v1.ga4.getReport |
| Guardrail delta | Guardrail metric change | No regression | doddle.tool.v1.ga4.getReport |

## Common Failure Modes

| Failure | Symptom | Fix |
|---------|---------|-----|
| Stopping early | False positives | Pre-commit sample size, don't peek |
| Changing mid-test | Invalid results | Freeze variants during run |
| Too small a change | Undetectable effect | Test bold, single-variable changes |
| Ignoring guardrails | Win that harms business | Define guardrails upfront, monitor |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Baseline rate, traffic, results | Sessions, conversions | no |
...
|-------|--------------------|--------------------|
| conversion-optimizer | Test ideation, variant design | Heuristic scores, hypotheses |
| copywriter | Variant copy | Headline, CTA alternatives |
| seo-specialist | SEO-sensitive page tests | Traffic-risk review |
