---
name: onboarding-cro
id: doddle.marketing.onboarding-cro
version: 1.5.1
...
- Optimizing first-run experience and time-to-value
- Fixing activation drop-off and stalled users
- Designing checklists, empty states, and onboarding emails
...
|-------|------|----------|-------------|
| page_url | string | yes | Onboarding entry or product URL to audit |
| goal | string | no | Activation goal (aha moment definition) |
...
|--------|------|-------------|
| audit_report | markdown | Scored onboarding audit, see Expected Output |
| patch_list | json | Prioritized fixes with impact/effort |
...
### Audit Summary
[Scores 1-5 across time-to-value, flow, empty states, multi-channel, retention]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Slow time-to-value | Low activation, long signup-to-value gap | Cut steps to aha moment, value-first entry |
| Checklist overwhelm | Setup started, never finished | 3-7 items, quick wins first, dismiss option |
| Stalled users | Inactive after partial setup | Trigger emails, welcome-back path, human outreach |
| Tour fatigue | Skipped tours, low feature adoption | Max 3-5 steps, contextual tooltips, user-initiated |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Activation funnel, retention cohorts | Step completion, D1/D7/D30 return | no |
| doddle.tool.v1.hubspot.contacts | Onboarding lifecycle, re-engagement | Lifecycle stage, stalled contacts | no |
...
|-------|--------------------|--------------------|
| conversion-optimizer | Onboarding audit, funnel review, test design | Heuristic scores, hypotheses |
| copywriter | Checklist, empty-state, tooltip, email copy | Benefit-led onboarding copy |
