...
id: doddle.marketing.analytics-attribution
version: 1.5.1
...
1. **Measurement context**
   - Channels, campaigns, sales cycle length?
   - Current tracking (UTM, goals, CRM integration)?
2. **Goal**
   - ROI, attribution, or funnel diagnosis?
   - Decisions this report will drive (budget shifts)?
...
|-------|------|----------|-------------|
| context | string | yes | Channels, campaigns, tracking setup to analyze |
| goal | string | no | Measurement goal (ROI, attribution, funnel) |
...
|--------|------|-------------|
| report | markdown | Performance, attribution, ROI findings |
| recommendations | json | Prioritized measurement and budget actions |

---

## Metrics to Track

See Marketing KPIs by Funnel Stage above. Engine-mapped targets:

| Metric | Definition | Target | Tool |
|--------|------------|--------|------|
| ROAS | Revenue / ad spend | > 3:1 | doddle.tool.v1.ga4.getReport |
| CAC | Spend / new customers | Decreasing | doddle.tool.v1.hubspot.contacts |
| Funnel conversion | Stage-to-stage rate | Increasing | doddle.tool.v1.ga4.getReport |
...
### Performance Summary
[Numbers with context vs target/previous]

### Recommendations
[Table: insight | action | owner]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Vanity reporting | Impressions without action | Tie every metric to decision |
| Last-click bias | Underfunded awareness | Multi-touch view |
| Broken tracking | Data mismatch | UTM + goal audit first |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Traffic, conversions, funnels | Sessions, goals | no |
| doddle.tool.v1.hubspot.contacts | Pipeline, revenue linkage | Contacts, deals | no |
| doddle.tool.v1.notion.pages | Report archive | Pages, dashboards | no |
...
1. Channels, sales cycle, and decisions this informs?
2. Current UTM, goal, CRM setup state?
3. Grant GA4/HubSpot access, or share exports?
