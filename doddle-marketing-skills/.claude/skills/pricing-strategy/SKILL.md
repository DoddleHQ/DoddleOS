...
id: doddle.marketing.pricing-strategy
version: 1.5.1
...
- Setting or changing pricing and packaging
- Choosing a value metric and tier structure
- Evaluating freemium vs. free trial
...
1. **Business context**
   - Product type, current pricing, target market, GTM motion?
2. **Value & competition**
   - Value delivered, alternatives considered, competitor pricing?
3. **Goal**
   - Growth, revenue, or profitability? (maps to blueprint `goal`)
...
|-------|------|----------|-------------|
| context | string | yes | Product type, current pricing, target market, GTM motion |
| goal | string | no | Primary goal (growth, revenue, profitability, upmarket move) |
...
|--------|------|-------------|
| strategy | markdown | Pricing strategy with value metric and tier structure |
| action_plan | json | Pricing tasks with owner, effort, impact |
...
|---------|----------------|-----------------|
| Cost-plus pricing | Ignores perceived value, leaves money | Value-based pricing anchored on differentiation |
| Wrong value metric | Price doesn't scale with value | Metric where more usage = more value |
| Too many tiers | Choice paralysis, sales confusion | Good-better-best, 3 tiers + enterprise |
| No willingness-to-pay research | Guesswork pricing | Van Westendorp / MaxDiff before setting points |
| Unplanned discounting | Erodes ARPU permanently | Annual prepay framing, guardrailed discounts |
| Avoiding increases | Inflation + value uncaptured | Scheduled, communicated increase motion |
...
|--------|------------|--------|------|
| ARPU | Revenue / users | Grow per pricing motion | doddle.tool.v1.hubspot.deals |
| Plan conversion | Paid / trials or visitors | > baseline | doddle.tool.v1.ga4.getReport |
| Expansion revenue | Upsell / cross-sell revenue | Net revenue retention >100% | doddle.tool.v1.hubspot.deals |
| Churn rate | Lost / total customers | < baseline | doddle.tool.v1.hubspot.deals |
...
### Pricing Strategy
[Value metric, tier structure, freemium vs trial call]

### Packaging
[Persona-mapped tiers, differentiation, enterprise handling]

### Test & Rollout Plan
[Price tests, increase communication, validation checklist]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Conversion drop | New pricing tanks signup | Re-test points, check metric mismatch |
| Downmarket churn | SMBs leave after increase | Grandfathering, downmarket tier |
| Sales confusion | Inconsistent discounting | Clear guardrails, packaging one-pager |
| Value metric mismatch | Heavy users underpay | Re-map usage to value, migrate tiers |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Pricing page performance | Visits, plan conversion | no |
| doddle.tool.v1.hubspot.deals | Revenue impact | ARPU, expansion, churn | no |
...
|-------|--------------------|--------------------|
| sales-enabler | Packaging, enterprise tiers | Sales-ready pricing narrative |
| copywriter | Pricing page copy | Tier naming, value framing |
| conversion-optimizer | Pricing page CRO | Page structure review |
| researcher | WTP research | Survey design, analysis |
