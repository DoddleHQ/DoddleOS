...
id: doddle.marketing.marketing-fundamentals
version: 1.5.1
...
1. **Funnel context**
   - Which stage (TOFU/MOFU/BOFU/retention) is the priority?
   - Who is the target audience and what job are they hiring for?
2. **Goal**
   - Primary outcome (awareness, leads, conversion, retention)?
   - Current baseline metrics (CAC, conversion, churn)?
...
|-------|------|----------|-------------|
| context | string | yes | Current marketing situation, audience, funnel stage |
| goal | string | no | Desired outcome (awareness, leads, conversion, retention) |
...
|--------|------|-------------|
| report | markdown | Fundamentals assessment with positioning and funnel guidance |
| recommendations | json | Prioritized actions with impact/effort |

---

## Metrics to Track

See Marketing Metrics Framework above. Key targets:

| Metric | Definition | Target | Tool |
|--------|------------|--------|------|
| CAC | Cost to acquire customer | < 1/3 LTV | doddle.tool.v1.ga4.getReport |
| LTV:CAC | Return on acquisition | > 3:1 | doddle.tool.v1.hubspot.contacts |
| Conversion rate | Visitors to customers | Increasing | doddle.tool.v1.ga4.getReport |
...
[Funnel stage diagnosis, positioning review]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Feature-first messaging | Low resonance | Lead with outcomes per Value Proposition Canvas |
| Full-funnel gap | Leaky bucket | Address weakest stage first (Theory of Constraints) |
| Untested positioning | Generic claims | Validate with customer research |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Traffic, funnel behavior | Sessions, conversions | no |
| doddle.tool.v1.hubspot.contacts | Lifecycle, lead quality | Contacts, stages | no |
| doddle.tool.v1.notion.pages | Playbooks, positioning docs | Pages, notes | no |
...
1. Which funnel stage and audience matter most right now?
2. What positioning and proof points do you have?
3. Current CAC, conversion, churn? (or grant GA4/HubSpot access?)
