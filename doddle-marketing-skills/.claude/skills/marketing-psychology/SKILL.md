...
id: doddle.marketing.marketing-psychology
version: 1.5.1
...
- Choosing persuasion tactics for a page, email, price, popup
- Diagnosing why users do not convert or retain
- Designing ethical tests of behavioral hypotheses
...
1. **Behavior context**
   - What behavior to influence, at which journey stage?
   - What does customer believe before encountering marketing?
2. **Goal**
   - What is blocking the action (friction, trust, urgency)?
   - What has been tested with real customers?
...
|-------|------|----------|-------------|
| context | string | yes | Challenge and customer behavior to influence |
| goal | string | no | Target behavior (conversion, trust, urgency) |
...
|--------|------|-------------|
| report | markdown | Applicable models with ethical applications |
| recommendations | json | Prioritized tactics to test |
...
|---------|----------------|-----------------|
| Dark patterns | Destroys trust | Apply ethically, genuine scarcity only |
| Overloading triggers | Choice paralysis | One primary trigger per asset |
| Copying tactics without diagnosis | Wrong model | Map challenge via Quick Reference first |
...
|--------|------------|--------|------|
| Conversion rate | Desired actions / visitors | Increasing | doddle.tool.v1.ga4.getReport |
| Test win rate | Successful hypothesis tests | Increasing | doddle.tool.v1.notion.pages |
| Retention rate | Customers retained | Increasing | doddle.tool.v1.hubspot.contacts |
...
### Applicable Models
[Models with psychology + ethical application]

### Test Plan
[Hypothesis, variant, metric per ab-test-setup]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Wrong diagnosis | Tactic does not move metric | Revisit Quick Reference mapping |
| Unethical framing | Backlash, refunds | Genuine claims only, add guarantees |
| No testing | Opinion-driven | A/B test each hypothesis |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Behavioral baseline | Funnel, conversions | no |
| doddle.tool.v1.hubspot.contacts | Segment response | Contacts, stages | no |
| doddle.tool.v1.notion.pages | Hypothesis log | Pages, notes | no |
...
|-------|--------------------|--------------------|
| conversion-optimizer | Page/trigger audit | Heuristic scores |
| copywriter | Message framing | Persuasive copy |
| researcher | Belief validation | Customer evidence |
