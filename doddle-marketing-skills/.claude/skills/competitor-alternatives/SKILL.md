...
id: doddle.marketing.competitor-alternatives
version: 1.5.1
...
|-------|------|----------|-------------|
| topic_or_url | string | yes | Your product or competitor URL/topic; ask if missing |
| keyword | string | no | Competitor name or vs/alternative query; infer if missing |
...
|--------|------|-------------|
| report | markdown | Comparison page strategy with structure, see Output Format |
| action_list | json | Prioritized pages and research tasks |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.semrush.keywordResearch | Competitor demand | Volume, difficulty | no |
| doddle.tool.v1.dataforseo.serpGoogle | SERP competition | Rankings, SERP features | no |
| doddle.tool.v1.gsc.getSearchAnalytics | Existing performance | Queries, CTR, position | no |
...
|-------|--------------------|--------------------|
| researcher | Competitor research | Feature, pricing, review mining |
| copywriter | Comparison copy | Balanced, persuasive copy |
| sales-enabler | Sales enablement | Battlecards, objection handling |
