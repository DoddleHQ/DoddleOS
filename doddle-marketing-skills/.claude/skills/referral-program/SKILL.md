...
id: doddle.marketing.referral-program
version: 1.5.1
...
- Designing a new customer referral or affiliate program
- Optimizing an existing program (referral rate, ROI, fraud)
- Choosing incentive structures and commission models
- Planning program launch and nurture sequences

## Initial Assessment

Before providing recommendations, understand (see Before Starting for full discovery; ask if missing):

1. **Program type**
   - Referral, affiliate, or hybrid? B2B or B2C?
2. **Economics**
   - Customer LTV, current CAC, incentive budget?
3. **Goal**
   - Acquisition volume, CAC reduction, or virality? (maps to blueprint `goal`)
...
|-------|------|----------|-------------|
| context | string | yes | Program type, customer LTV, current CAC, existing program state |
| goal | string | no | Primary goal (acquisition volume, CAC reduction, virality) |
...
|--------|------|-------------|
| strategy | markdown | Referral program strategy with incentive structure |
| action_plan | json | Program tasks with owner, effort, impact |
...
|---------|----------------|-----------------|
| Incentive mis-sized vs LTV | Too small (no action) or too large (unit economics break) | Size reward as fraction of LTV, test tiers |
| High-friction share flow | Referral dies at extra steps | One-click share, unique links auto-generated |
| No trigger moments | Asks arrive at wrong time | Prompt at aha / success moments |
| Ignoring fraud | Fake accounts drain budget | Caps, verification, anomaly review |
| No referrer nurture | One ask, then silence | Launch + nurture + re-engagement sequences |
...
|--------|------------|--------|------|
| Referral rate | Referrers / customers | Benchmark, grow MoM | doddle.tool.v1.hubspot.deals |
| Viral coefficient (K) | Invites × conversion per user | >0.3 toward >1 | doddle.tool.v1.ga4.getReport |
| Referral CAC | Program cost / referred customers | < paid CAC | doddle.tool.v1.hubspot.deals |
| Referred conversion | Referred signup → paid rate | > baseline | doddle.tool.v1.ga4.getReport |
...
### Program Strategy
[Referral vs affiliate choice, loop design, incentive structure]

### ROI Model
[Viral coefficient math, CAC vs LTV guardrails]

### Sequences & Checklist
[Launch, nurture, re-engagement + pre-launch checklist status]
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Low share rate | Few customers refer | Better trigger moments, simpler share, stronger incentive |
| Reward gaming | Fraud spike, fake accounts | Verification, caps, manual review |
| Referred churn | Referred users don't stick | Align incentive to activated/paid, not signup |
| Unattractive rewards | Ignored offers | Research perk equivalents, test two-sided rewards |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Referral traffic, conversion | Sessions, signup rate by source | no |
| doddle.tool.v1.hubspot.deals | Referral pipeline, CAC | Referred deals, cost per deal | no |
...
|-------|--------------------|--------------------|
| planner | Program design | Loop + incentive plan |
| copywriter | Share mechanics copy | Invite, landing, email copy |
| email-wizard | Referral sequences | Launch, nurture, re-engagement |
| conversion-optimizer | Flow CRO | Share-flow friction review |
