---
name: email-sequence
id: doddle.marketing.email-sequence
version: 1.5.1
...
- Creating welcome, nurture, re-engagement, or post-purchase sequences
- Designing lifecycle or event-triggered email programs
- Auditing and optimizing an existing sequence
- Writing email copy within a sequence arc
...
|-------|------|----------|-------------|
| brief | string | yes | Sequence type, trigger, goal, number of emails |
...
|--------|------|-------------|
| draft | markdown | Full sequence, see Expected Output Format |
| variants | json | Alternative subject lines and CTAs with rationale |
...
|--------|------------|--------|------|
| Open Rate | % opening email | 20-30% | ESP dashboard |
| Click-Through Rate | % clicking any link | 2-5% | ESP dashboard |
| Click-to-Open Rate | % of openers who click | 10-15% | ESP dashboard |
| Conversion Rate | % completing desired action | 1-3% | Google Analytics |

### Sequence Health Metrics
| Metric | Definition | Target | Tool |
|--------|------------|--------|------|
| unsubscribe Rate | % unsubscribing per email | <0.5% | ESP dashboard |
| Bounce Rate | % undeliverable | <2% | ESP dashboard |
| Spam Complaint Rate | % marking as spam | <0.1% | ESP dashboard |
| List Growth Rate | Net new subscribers | >5% monthly | ESP dashboard |

### Revenue Metrics
| Metric | Definition | Target | Tool |
|--------|------------|--------|------|
| Revenue per Email | Revenue generated per email sent | Varies | ESP + GA |
| Customer Lifetime Value | Total value of converted leads | Track trend | CRM |
| Cost per Acquisition | Marketing spend per customer | Below LTV | Finance |

### Timing Metrics
| Metric | Definition | Target | Tool |
|--------|------------|--------|------|
| Time to First Open | How quickly subscribers open | <24 hours | ESP |
| Time Between Emails | Optimal spacing | Test 1-3 days | ESP |
| Best Send Time | When subscribers engage most | Test & optimize | ESP |
...
|---------|----------------|-----------------|
| Too many emails too fast | Causes fatigue, unsubscribes | Start slow, increase gradually |
| No segmentation | Same message to everyone | Segment by behavior/interest |
| Selling too early | No trust yet | Value first, sell later |
| No clear goal per email | Confused subscribers | One email = one job |

### Execution Mistakes
| Mistake | Why It's Wrong | Do This Instead |
|---------|----------------|-----------------|
| Generic subject lines | Low open rates | Personalize, be specific |
| Too many CTAs | Decision paralysis | One primary CTA |
| Long paragraphs | Hard to scan on mobile | Short paragraphs, bullets |
| No mobile optimization | 60%+ read on mobile | Mobile-first design |

### Deliverability Mistakes
| Mistake | Why It's Wrong | Do This Instead |
|---------|----------------|-----------------|
| Not warming up IP | Goes to spam | Gradually increase volume |
| No double opt-in | Low quality list | Confirm subscribers |
| Ignoring bounces | Hurts reputation | Clean list regularly |
| No unsubscribe option | Legal risk, spam complaints | Always include one |

### Analysis Mistakes
| Mistake | Why It's Wrong | Do This Instead |
|---------|----------------|-----------------|
| Not A/B testing | Missing optimizations | Test subject lines, CTAs |
| Ignoring segmentation data | Missing insights | Analyze by segment |
| No revenue attribution | Can't prove ROI | Track conversions to revenue |
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Selling too early | Low engagement, unsubscribes | Front-load value, delay pitch |
| No segmentation | Same message to everyone | Segment by behavior and trigger |
| Deliverability collapse | Spam placement, bounces | Warm up, clean list, double opt-in |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.hubspot.contacts | Segments, lifecycle, performance | Contact data, engagement | no |
| doddle.tool.v1.notion.pages | Briefs, sequence docs | Plans, drafts | no |
...
|-------|--------------------|--------------------|
| email-wizard | Sequence build, automation | Flow design, timing |
| copywriter | Landing pages emails link to | Page copy |
| lead-qualifier | Segmentation strategy | Scoring, audience analysis |
