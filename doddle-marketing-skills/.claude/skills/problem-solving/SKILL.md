...
id: doddle.marketing.problem-solving
version: 1.5.1
...
Before recommending a technique, understand:

1. **Problem context**
   - Which type (complexity, creative block, recurring pattern, assumption, scale, stuck)?
   - What has been tried; what constraints (time, budget)?
2. **Goal**
   - Outcome to unblock and smallest testable step?
...
|-------|------|----------|-------------|
| context | string | yes | Problem type, stalled campaign, constraints |
| goal | string | no | Outcome to unblock (simplify, breakthrough, scale) |
...
|--------|------|-------------|
| report | markdown | Diagnosis with technique application and action plan |
| recommendations | json | Prioritized next steps with smallest test |
...
|---------|----------------|-----------------|
| Optimizing wrong level | Local optimum | Zoom out before zooming in |
| Skipping smallest test | Big-bang risk | Ship minimum to validate |
| No learning capture | Repeats problem | Document in playbook |
...
|--------|------------|--------|------|
| Time to unblock | Days stalled to action | Decreasing | doddle.tool.v1.notion.pages |
| Test throughput | Small tests shipped | Increasing | doddle.tool.v1.notion.pages |
| Outcome lift | Metric moved by fix | Increasing | doddle.tool.v1.ga4.getReport |
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Wrong technique | No progress | Re-run Step 1 identification |
| Analysis paralysis | Endless options | Apply When Stuck constraint |
| No follow-through | Insight unused | Assign owner + metric |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Diagnose funnel/traffic | Sessions, conversions | no |
| doddle.tool.v1.hubspot.contacts | Segment patterns | Contacts, stages | no |
| doddle.tool.v1.notion.pages | Learning log | Pages, playbooks | no |
...
|-------|--------------------|--------------------|
| brainstormer | Breakthrough ideas | Collision-zone concepts |
| planner | Action sequencing | Plans, calendars |
| researcher | Root-cause data | Evidence |

---

## Related Skills

- **marketing-fundamentals**: For funnel and positioning basics
- **marketing-psychology**: For behavioral diagnosis
- **ab-test-setup**: For testing solutions

---

## Questions to Ask

1. Which problem type best describes being stuck?
2. Constraints (time, budget) and what was tried?
3. Goal and smallest test you can ship this week?
