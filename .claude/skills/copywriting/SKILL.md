---
name: copywriting
id: doddle.marketing.copywriting
version: 1.5.1
...
- Writing homepage, landing, pricing, feature, about, or product page copy
- Rewriting underperforming page copy
- Drafting headlines, subheadlines, and CTAs
- Structuring persuasive page narratives

## Initial Assessment

Before writing, gather the context in Before Writing below (page purpose, audience, offer, traffic context). If missing, ask.
...
|-------|------|----------|-------------|
| brief | string | yes | Page type, goal, offer, key points to cover |
...
|--------|------|-------------|
| draft | markdown | Page copy organized by section, see Expected Output Format |
...
|---------|----------------|-----------------|
| Leading with features | Doesn't connect to reader pain | Lead with benefits and outcomes |
| One generic message for all | Resonates with no one | Target one audience per page |
| No clear primary CTA | Visitors don't know what to do | One obvious action per section |

### Execution Mistakes
| Mistake | Why It's Wrong | Do This Instead |
|---------|----------------|-----------------|
| Clever over clear | Sacrifices comprehension | Clear > clever, always |
| Walls of text | Hard to scan | Short paragraphs, headers, bullets |
| Jargon-heavy copy | Confuses outsiders | Use customer language |
...
|--------|------------|--------|------|
| Conversion Rate | % completing primary action | 2-5% | Google Analytics |
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Vague value prop | High bounce, low scroll | Rewrite headline with specific outcome |
| Weak CTA | Page views but no clicks | Value-led CTA, add risk reversal |
| Feature dump | Low engagement mid-page | Cut to 3-5 benefits, add proof |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.notion.pages | Briefs, drafts, brand docs | Page content, guidelines | no |
| doddle.tool.v1.ga4.getReport | Page performance baseline | Conversions, bounce, time on page | no |
...
|-------|--------------------|--------------------|
| copywriter | Drafting, rewriting | Page copy, headline variants |
| brand-voice-guardian | Voice check | Tone consistency review |
| conversion-optimizer | Low-converting pages | CRO audit, test hypotheses |
...
2. Who is the ideal customer and their main objection?
3. Offer, differentiator, and available proof points?
4. Traffic source — what do visitors already know?
