...
id: doddle.marketing.programmatic-seo
version: 1.5.1
...
|-------|------|----------|-------------|
| topic_or_url | string | yes | Seed topic or site URL; ask if missing |
| keyword | string | no | Keyword pattern or example query; infer if missing |
...
|--------|------|-------------|
| report | markdown | Opportunity analysis with template structure, see Output Format |
| action_list | json | Prioritized page patterns and launch steps |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.semrush.keywordResearch | Pattern demand | Volume, difficulty | no |
...
|-------|--------------------|--------------------|
| seo-specialist | Pattern validation, template SEO | Keyword, meta, schema review |
| copywriter | Template copy | Scalable page copy |
| planner | Launch planning | Phased rollout plan |
