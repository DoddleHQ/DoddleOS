...
id: doddle.marketing.free-tool-strategy
version: 1.5.1
...
|-------|------|----------|-------------|
| topic_or_url | string | yes | Product or audience topic; ask if missing |
| keyword | string | no | Tool-related keyword; infer if missing |
...
|--------|------|-------------|
| report | markdown | Tool strategy with concept and build approach, see Output Format |
| action_list | json | Prioritized tool ideas with scores and next steps |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.semrush.keywordResearch | Tool demand | Volume, difficulty | no |
| doddle.tool.v1.dataforseo.serpGoogle | SERP competition | Rankings, SERP features | no |
| doddle.tool.v1.ga4.getReport | Funnel attribution | Traffic, conversions | no |
...
|-------|--------------------|--------------------|
| researcher | Opportunity research | Demand and competitor analysis |
| copywriter | Landing page copy | Tool page and promo copy |
| planner | Build planning | MVP scope and timeline |
