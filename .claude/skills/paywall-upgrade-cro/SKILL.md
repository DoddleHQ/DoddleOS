...
id: doddle.marketing.paywall-upgrade-cro
version: 1.5.1
...
- Optimizing freemium → paid conversion
- Designing trial expiration flows
- Fixing usage-limit or feature-gate paywalls
- Improving team/seat upgrade prompts
- Testing paywall copy, pricing, timing
...
|-------|------|----------|-------------|
| paywall_url | string | yes | Paywall or upgrade screen URL to audit |
| plan | string | no | Target plan or tier, ex Pro, Team |
...
|--------|------------|--------|------|
| Paywall impression rate | Paywall views / eligible users | Benchmark | doddle.tool.v1.ga4.getReport |
| Click-through to upgrade | Upgrade clicks / paywall views | Benchmark | doddle.tool.v1.ga4.getReport |
| Upgrade completion rate | Completed upgrades / upgrade starts | Benchmark | doddle.tool.v1.hubspot.deals |
| Revenue per user | Revenue / exposed users | Increase | doddle.tool.v1.hubspot.deals |
| Churn post-upgrade | Cancellations / new paid users | Decrease | doddle.tool.v1.hubspot.deals |

## Common Failure Modes

| Failure | Symptom | Fix |
|---------|---------|-----|
| Ask before value | Low conversion, high dismiss | Trigger after aha moment |
| Too frequent prompts | Rage clicks, churn | Cool-down days, cap per session |
| Blocking critical flows | Drop-off, complaints | Soft prompt, clear exit path |
| Unclear pricing | Abandoned checkout | Simple pricing, annual/monthly trade-off |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Traffic, paywall views, CTR | Sessions, conversion | no |
| doddle.tool.v1.hubspot.deals | Upgrade pipeline, revenue | Deals, stage, value | no |
...
|-------|--------------------|--------------------|
| conversion-optimizer | Paywall audit, test design | Heuristic scores, hypotheses |
| copywriter | Paywall copy rewrite | Benefit-led copy |
| seo-specialist | Adjacent pricing page SEO | Keyword, meta review |
