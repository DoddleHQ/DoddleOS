...
id: doddle.marketing.marketing-ideas
version: 1.5.1
...
- User needs growth ideas for SaaS/software product
- Choosing channels by stage, budget, timeline
- Turning a chosen idea into implementation steps
...
1. **Product context**
   - Product, target customer, current stage?
   - What has been tried (worked / did not)?
2. **Goal**
   - Primary growth goal and timeline?
...
|-------|------|----------|-------------|
| context | string | yes | Product, audience, stage, resources tried |
| goal | string | no | Growth goal (acquisition, activation, expansion) |
...
|--------|------|-------------|
| report | markdown | Ranked ideas with why-fit and how-to-start |
| recommendations | json | Prioritized ideas with outcome and resources |
...
|---------|----------------|-----------------|
| Copying competitors blindly | Different stage/resources | Filter by stage, budget, timeline |
| Too many ideas at once | Spread thin | Pick 3-5, test smallest first |
| Ignoring quick wins vs compounding | Wrong timeline mix | Balance quick wins + long-term |
...
|--------|------------|--------|------|
| Idea throughput | Ideas tested per quarter | Increasing | doddle.tool.v1.notion.pages |
| CAC per channel | Spend / customers by idea | Decreasing | doddle.tool.v1.ga4.getReport |
| Activation rate | New users reaching value | Increasing | doddle.tool.v1.hubspot.contacts |
...
| Failure | Symptom | Fix |
|---------|---------|-----|
| Stage mismatch | Enterprise tactic at pre-launch | Use Implementation Tips by stage |
| No follow-through | Ideas never shipped | Ship smallest test per idea |
| No measurement | Unknown what worked | Define outcome per recommendation |
...
|---------|-------------|--------------|----------|
| doddle.tool.v1.ga4.getReport | Baseline traffic/conversion | Sessions, conversions | no |
| doddle.tool.v1.hubspot.contacts | Lead quality by source | Contacts, stages | no |
| doddle.tool.v1.notion.pages | Idea backlog, plans | Pages, notes | no |
...
|-------|--------------------|--------------------|
| brainstormer | Idea generation | Divergent concepts |
| planner | Prioritization | Calendars, sequencing |
| researcher | Validation | Market, competitor data |
