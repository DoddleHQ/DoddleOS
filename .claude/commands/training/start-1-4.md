...
```
Review the Doddle Marketing OS campaign brief from three agent perspectives:
...
```
/leads:qualify "Doddle Marketing OS productivity tool"
```
...
```
/sequence:nurture "Doddle Marketing OS" "leads who downloaded our guide"
```
...
```
/sales:pitch "enterprise company considering Doddle Marketing OS" "team coordination"
```
