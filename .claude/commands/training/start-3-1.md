...
In this module, you'll master the new CRO (Conversion Rate Optimization) skills added to Doddle Marketing OS. These skills help you systematically improve conversion rates across all marketing assets.
...
Doddle Marketing OS includes 7 specialized CRO skills:
...
## Exercise 1: Audit Doddle Marketing OS's Landing Page

Let's apply CRO principles to Doddle Marketing OS's landing page.
...
```bash
/cro:page "Analyze Doddle Marketing OS's landing page: Headline 'Team Productivity Software', CTA 'Learn More', 7-field form. Target: remote team managers."
```
...
```bash
/marketing:psychology "How can we use loss aversion and social proof to improve Doddle Marketing OS's trial signup rate?"
```
...
1. **Run page audit:**
   ```bash
   /cro:page "Doddle Marketing OS homepage audit"
   ```

2. **Optimize the form:**
   ```bash
   /cro:form "Reduce Doddle Marketing OS's 7-field trial signup form"
   ```

3. **Design A/B test:**
   ```bash
   /test:ab-setup "Test new headline vs current for Doddle Marketing OS"
   ```
