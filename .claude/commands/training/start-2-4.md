...
**Weekly Report:**
```
/report:weekly "Doddle Marketing OS" "current week"
```

**Monthly Report:**
```
/report:monthly "Doddle Marketing OS" "current month"
```
...
```
/checklist:analytics-monthly "current month" "Doddle Marketing OS"
```
