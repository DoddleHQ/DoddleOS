...
> You're a Marketing Strategist at **Markit** agency. Your client is **Doddle Marketing OS**. Your mission:
...
```
/campaign:plan "Doddle Marketing OS Q1 Product Launch - Target: 1000 trial signups in 30 days, Budget: $50K, Channels: LinkedIn, Google Ads, Content, Email"
```
...
```
/content:social "Product launch announcement for Doddle Marketing OS based on the campaign brief" "linkedin"
```
