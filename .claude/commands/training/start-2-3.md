...
```
/sequence:welcome "Doddle Marketing OS" "trial users - remote team managers"
```
...
**LinkedIn:**
```
/content:social "Team coordination tips for remote managers - Doddle Marketing OS launch" "linkedin"
```
...
```
/content:landing "14-day free trial of Doddle Marketing OS" "remote team managers at tech companies"
```
