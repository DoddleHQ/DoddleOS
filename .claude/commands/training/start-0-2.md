...
Now let's do some real marketing work. We'll create brand guidelines for Doddle Marketing OS using the `/brand:voice` command.
...
```
/brand:voice "Doddle Marketing OS - B2B team productivity coordination tool for remote teams"
```
...
```
/research:persona "Remote team managers at tech companies using Doddle Marketing OS"
```
...
**Email Sequences:**
```
/sequence:welcome "Doddle Marketing OS" "trial users"
```
